...
impl SessionUpdateSender {
    fn new(acp_sender: mpsc::UnboundedSender<acp::SessionNotification>, session_id: acp::SessionId) -> Self {
        Self { acp_sender, session_id }
    }
...
impl QCliAgent {
    async fn new() -> Self {
        ...
        let session_id = acp::SessionId("default".into());
        let session_update_sender = SessionUpdateSender::new(acp_sender, session_id.clone());
